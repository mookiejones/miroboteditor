...
namespace miRobotEditor.Classes
{
    public class VariableHelper
    {
        ...
        //    var m = FindMatches(DummyDoc.ActiveEditor.Robot.XYZRegex, filename);
        ...
        //{
        //    BitmapImage icon = Utilities.LoadBitmap(Global.imgXYZ);
        //    var m = FindMatches(DummyDoc.ActiveEditor.Robot.FieldRegex, filename);
        ...
        //    var m = FindMatches(DummyDoc.ActiveEditor.Robot.MethodRegex, filename);
