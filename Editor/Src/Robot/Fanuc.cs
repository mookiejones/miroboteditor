...
{
    public class Fanuc : AbstractRobotClass
    {
        ...
        internal override Enums.TYPROBOT RobotType { get { return Enums.TYPROBOT.Fanuc; } }
        ...
        public class RegionFoldingStrategy : ICSharpCode.AvalonEdit.Folding.AbstractFoldingStrategy
        {
            /// <summary>
            ...
            public IEnumerable<NewFolding> CreateNewFoldings(ITextSource document)
            {
                ...
                newFoldings.AddRange(RobotBase.CreateFoldingHelper(document, ";fold", ";endfold", true));
  //              newFoldings.AddRange(RobotBase.CreateFoldingHelper(document, "def", "end", false));
