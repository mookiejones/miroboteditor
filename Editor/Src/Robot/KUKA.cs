...
namespace miRobotEditor.Robot
{
    public class KUKA : AbstractRobotClass
    {
      ...
      //  }
        ...
        private static GUI.Editor.Editor GetPointsFromArray(GUI.Editor.Editor editor, Collection<string> points)
        {
        ...
        public static GUI.Editor.Editor ReversePath(GUI.Editor.Editor editor)
        {
  ...
  //     }
        ...
        public override Regex MethodRegex { get { return new Regex(@"^[GLOBAL ]*(DEFFCT|DEF)+\s+([\w\d]+\s+)?([\w\d_]*)\s*\(", ro); } }
        ...
        public override Regex XYZRegex { get { return new Regex(@"^[DECL ]*(E6POS|E6AXIS) ([\w\d_]+)", ro); } }
        #endregion
    }
    }
