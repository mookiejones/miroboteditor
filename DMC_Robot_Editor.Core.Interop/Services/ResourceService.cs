...
namespace miRobotEditor.Core.Services
{
    ...
    public static class ResourceService
    {
        ...
        public static void InitializeService(string resourceDirectory)
        {
            ...
            PropertyService.PropertyChanged += new PropertyChangedEventArgs(OnPropertyChange);
        ...
        public static void RegisterStrings(string baseResourceName, Assembly assembly)
        {
            ...
            var ra = new ResourceAssembly(assembly, baseResourceName, false);
        ...
        public static void RegisterImages(string baseResourceName, Assembly assembly)
        {
            ...
            var ra = new ResourceAssembly(assembly, baseResourceName, true);
            resourceAssemblies.Add(ra);
            ra.Load();
        }
