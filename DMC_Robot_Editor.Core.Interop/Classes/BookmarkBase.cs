...
namespace miRobotEditor.Core
{
    ...
    public class BookmarkBase : IBookmark
    {
        ...
        public IDocument Document
        {
            ...
            set
            {
                if (document != value)
                {
                    ...
                    document = value;
                    CreateAnchor();
                    OnDocumentChanged(System.EventArgs.Empty);
                }
            }
        }
        ...
        void AnchorDeleted(object sender, System.EventArgs e)
        {
        ...
        protected virtual void OnDocumentChanged(System.EventArgs e)
        {
