...
namespace InlineFormParser.Zip
{
	internal class ZipCrypto
	{
		...
		public static ZipCrypto ForWrite(string password)
		{
			...
			if (password == null) throw new BadPasswordException("This entry requires a password.");
		...
		public static ZipCrypto ForRead(string password, ZipEntry e)
		{
			...
			{
				if ((e._BitField & 8) != 8) throw new BadPasswordException("The password did not match.");
				if (array[11] != (byte) ((e._TimeBlob >> 8) & 0xFF)) throw new BadPasswordException("The password did not match.");
			}
		...
		public void InitCipher(string passphrase)
		{
			...
			for (int i = 0; i < passphrase.Length; i++) UpdateKeys(array[i]);
		}
