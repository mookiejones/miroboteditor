...
namespace DMC_Engineering.miRobotEditor.Sda
{
	...
	{
		miRobotEditorHost.CallbackHelper callback;
		...
		public void InitSharpDevelopCore(miRobotEditorHost.CallbackHelper callback, StartupSettings properties)
		{
			// creating the service manager initializes the logging service etc.
			DMC_Engineering.Core.Services.ServiceManager.Instance = new SDServiceManager();
