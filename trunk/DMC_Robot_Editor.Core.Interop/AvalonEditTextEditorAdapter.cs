...
namespace miRobotEditor.Core
{
    ...
    /// </summary>
    public class AvalonEditDocumentAdapter : ITextEditor, IWeakEventListener
    {
        ...
        public AvalonEditDocumentAdapter(TextEditor textEditor)
        {
            ...
            this.Options = new OptionsAdapter(textEditor);
        ...
        protected virtual bool ReceiveWeakEvent(Type managerType, object sender, System.EventArgs e)
        {
