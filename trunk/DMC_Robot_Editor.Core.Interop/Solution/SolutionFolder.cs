    ...
    public class SolutionFolder : AbstractSolutionFolder, ISolutionFolderContainer
    {
        ...
        public virtual ProjectSection SolutionItems
        {
            get
            {
                ...
                var solutionItems = new ProjectSection("SolutionItems", "postProject");
        ...
        public bool IsAncestorOf(ISolutionFolder folder)
        {
            ...
            {
                var curFolder = (ISolutionFolder)curParent;
                if (curFolder == this)
                {
                    return true;
                }
        ...
        {
            var newFolder = new SolutionFolder(title, location, guid);
