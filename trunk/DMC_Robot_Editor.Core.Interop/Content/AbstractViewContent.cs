...
namespace miRobotEditor.Core.Content
{
    ...
    public abstract class AbstractViewContent : IViewContent
    {
        ...
        public string TabPageText
        {
            ...
            set
            {
                if (tabPageText != value)
                {
                    ...
                    {
                        TabPageTextChanged(this, System.EventArgs.Empty);
                    }
                }
            }
        }
        ...
        void RegisterFileEventHandlers(OpenedFile newItem)
        {
            ...
            OnIsDirtyChanged(null, System.EventArgs.Empty); // re-evaluate this.IsDirty after changing the file collection
        }
        ...
        void OnFileNameChanged(object sender, System.EventArgs e)
        {
            OnFileNameChanged((OpenedFile)sender);
            if (titleName == null && files.Count > 0 && sender == files[0])
            {
                OnTitleNameChanged(System.EventArgs.Empty);
            }
        }
        ...
        void OnTitleNameChanged(System.EventArgs e)
        {
        ...
        void OnTitleNameLocalizationChanged(object sender, System.EventArgs e)
        {
        ...
        void OnInfoTipChanged()
        {
            ...
            {
                InfoTipChanged(this, System.EventArgs.Empty);
            }
        }
        ...
        void OnInfoTipLocalizationChanged(object sender, System.EventArgs e)
        {
        ...
        void OnIsDirtyChanged(object sender, System.EventArgs e)
        {
            bool newIsDirty = IsDirtyInternal;
            if (newIsDirty == isDirty) return;
            isDirty = newIsDirty;
            RaiseIsDirtyChanged();
        }
        ...
        void OnActiveViewContentChanged(object sender, System.EventArgs e)
        {
