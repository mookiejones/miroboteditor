...
using miRobotEditor.Core.Content;
...
namespace miRobotEditor.Core.Services
{
	...
	public sealed class NavigationService
	{
		...
		public static void ContentChanging(object sender, System.EventArgs e)
		{
		...
		/// </summary>
		static void ProjectService_SolutionLoading(object sender, System.EventArgs e)
		{
			SuspendLogging();
		}
		...
		/// </summary>
		static void LoadSolutionProjectsThreadEnded(object sender, System.EventArgs e)
		{
			ResumeLogging();
		}
		...
		/// </summary>
		static void ActiveViewContentChanged(object sender, System.EventArgs e)
		{
		...
		/// 
		/// </summary>
		static void ProjectService_SolutionClosed(object sender, System.EventArgs e)
		{
		...
		static void OnHistoryChanged()
		{
			if (HistoryChanged!=null) {
				HistoryChanged(NavigationService.CurrentPosition, System.EventArgs.Empty);
			}
...
//		}
		...
		/// <param name="e"></param>
		void ContentChanging(object sender, System.EventArgs e);
	}
}
