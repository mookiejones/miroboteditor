...
using DMC_Engineering.miRobotEditor.Sda;

namespace DMC_Engineering.miRobotEditor.Sda
{
	/// <summary>
	/// This class can host an instance of miRobotEditor inside another
	/// AppDomain.
	/// </summary>
	public sealed class miRobotEditorHost
	{
		#region CreateDomain
		/// <summary>
		/// Create an AppDomain capable of hosting miRobotEditor.
		/// </summary>
		public static AppDomain CreateDomain()
		{
			return AppDomain.CreateDomain("miRobotEditor.Sda", null, CreateDomainSetup());
		}
		
		/// <summary>
		/// Creates an AppDomainSetup specifying properties for an AppDomain capable of
		/// hosting miRobotEditor.
		/// </summary>
		public static AppDomainSetup CreateDomainSetup()
		{
			...
			s.ApplicationName = "miRobotEditor.Sda";
			return s;
		}
		#endregion
		...
		internal static Assembly SdaAssembly {
			get {
				return typeof(miRobotEditorHost).Assembly;
			}
		}
		#endregion
		...
		#region Constructors
		/// <summary>
		/// Create a new AppDomain to host miRobotEditor.
		/// </summary>
		public miRobotEditorHost(StartupSettings startup)
		{
			if (startup == null) {
		...
		/// <summary>
		/// Host miRobotEditor in the existing AppDomain.
		/// </summary>
		public miRobotEditorHost(AppDomain appDomain, StartupSettings startup)
		{
			if (appDomain == null) {
		...
		/// In that case, RunWorkbench will block until miRobotEditor is shut down!
		/// </summary>
		...
		/// are lost, but miRobotEditor still terminates correctly and saves changed
		/// settings.</param>
		...
		/// <summary>
		/// Unload the miRobotEditor AppDomain. This will force miRobotEditor to close
		...
		/// <summary>
		/// Gets the AppDomain used to host miRobotEditor.
		/// </summary>
		...
		/// <summary>
		/// Event when miRobotEditor starts to compile a project or solution.
		/// </summary>
		public event EventHandler StartBuild;
		
		/// <summary>
		/// Event when miRobotEditor finishes to compile a project or solution.
		/// </summary>
		public event EventHandler EndBuild;
		
		/// <summary>
		/// Event when a solution was loaded inside miRobotEditor.
		/// </summary>
		...
		/// <summary>
		/// Event when a file was loaded inside miRobotEditor.
		/// </summary>
		public event EventHandler<FileEventArgs> FileLoaded;
		
		/// <summary>
		/// Event when a file was saved inside miRobotEditor.
		/// </summary>
		...
		internal sealed class CallbackHelper : MarshalByRefObject
		{
			...
			readonly miRobotEditorHost host;
			
			public CallbackHelper(miRobotEditorHost host)
			{
				this.host = host;
			}
