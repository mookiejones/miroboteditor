...
{
	/// <summary>
	/// This class contains properties you can use to control how miRobotEditor is launched.
	/// </summary>
	[Serializable]
	public sealed class StartupSettings
	{
		bool useSharpDevelopErrorHandler = true;
		string applicationName = "miRobotEditor";
		...
		string resourceAssemblyName = "miRobotEditor";
		...
		/// <summary>
		/// Gets/Sets whether the miRobotEditor exception box should be used for
		...
		/// miRobotEditor windows. The default is "miRobotEditor".
		/// </summary>
		...
		/// Use null (default) to use the base directory of the miRobotEditor AppDomain.
		/// </summary>
		...
		/// <summary>
		/// Gets/Sets the directory used to store miRobotEditor properties,
