...
{
    public class ValueBoxModel :DependencyObject
    {
        ...
        public static readonly DependencyProperty V1Property =
            DependencyProperty.Register("V1", typeof(double), typeof(ValueBoxModel), new PropertyMetadata(0));
        ...
        public static readonly DependencyProperty V2Property =
            DependencyProperty.Register("V2", typeof(double), typeof(ValueBoxModel), new PropertyMetadata(0));
        ...
        public static readonly DependencyProperty V3Property =
            DependencyProperty.Register("V3", typeof(double), typeof(ValueBoxModel), new PropertyMetadata(0));
        ...
        public static readonly DependencyProperty V4Property =
            DependencyProperty.Register("V4", typeof(double), typeof(ValueBoxModel), new PropertyMetadata(0));
