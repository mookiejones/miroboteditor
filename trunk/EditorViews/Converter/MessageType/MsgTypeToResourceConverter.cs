namespace miRobotEditorViews.Converter.MessageType
{
  using System;
  ...
  [ValueConversion(typeof(miRobotEditorViews.Msg.MsgCategory), typeof(System.Windows.Media.ImageSource))]
  public class MsgTypeToResourceConverter : IValueConverter
  {
    ...
    public object Convert(object value, Type targetType, object parameter, System.Globalization.CultureInfo culture)
    {
      ...
      if (!(value is miRobotEditorViews.Msg.MsgCategory))
      ...
      switch ((miRobotEditorViews.Msg.MsgCategory)value)
      {
        case miRobotEditorViews.Msg.MsgCategory.Information:
          break;
        case miRobotEditorViews.Msg.MsgCategory.Error:
          resourceUri = "Images/MessageIcons/Error.png";
          break;
        case miRobotEditorViews.Msg.MsgCategory.Warning:
          resourceUri = "Images/MessageIcons/Warning.png";
          break;
        case miRobotEditorViews.Msg.MsgCategory.InternalError:
          resourceUri = "Images/MessageIcons/InternalError.png";
          break;
        case miRobotEditorViews.Msg.MsgCategory.Unknown:
        default:
