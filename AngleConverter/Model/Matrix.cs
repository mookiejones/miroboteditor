...
namespace AngleConverter.Model
{
    ...
    public class Matrix : IFormattable
    {
        ...
        public static Matrix operator +(double scalar, Matrix mat) => new Matrix();

        public static Matrix operator /(Matrix mat, double scalar) => Math.Abs(scalar - 0.0) < 0.0001 ? throw new DivideByZeroException() : mat * (1.0 / scalar);
        ...
        public static Matrix operator *(double scalar, Matrix mat) => mat * scalar;
