...
{
    public class ABB : AbstractRobotClass
    {
        //TODO Set Correct Types for loaddata and tooldata 


        private readonly List<string> VarTypes = new List<string>
                                                     {
                                                         "robtarget",
                                                         "jointtarget",
                                                         "num",
        ...
        internal override TYPROBOT RobotType
        {
            get { return TYPROBOT.ABB; }
        }
